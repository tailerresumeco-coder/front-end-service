        ...
        <main id="main-content" className="max-w-7xl mx-auto px-8 py-20" role="main">
          <section className="grid grid-cols-2 gap-12 items-center" aria-labelledby="hero-heading">
            ...
            <article>
              ...
              <div className="bg-brand-primary/10 border-l-4 border-brand-primary p-4 rounded-r-lg mb-6">
                <p className="text-text-primary text-body leading-relaxed">
                   Tailer Resume uses AI to optimize your resume for any job in under 30 seconds. Upload your resume, paste the job description, and get an ATS-friendly, keyword-optimized resume that increases your interview chances by 3x.
                </p>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-8 py-16" aria-labelledby="features-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <article className="bg-surface-dark/50 backdrop-blur-sm rounded-xl p-6 border border-border-primary">
              <h3 className="text-xl font-bold text-brand-primary mb-3">AI-Powered Tailoring</h3>
              <p className="text-text-secondary">Our AI analyzes job descriptions and automatically optimizes your resume with relevant keywords and skills.</p>
            </article>
            <article className="bg-surface-dark/50 backdrop-blur-sm rounded-xl p-6 border border-border-primary">
              <h3 className="text-xl font-bold text-brand-primary mb-3">ATS Optimization</h3>
              <p className="text-text-secondary">Ensure your resume passes Applicant Tracking Systems with proper formatting and keyword placement.</p>
            </article>
            <article className="bg-surface-dark/50 backdrop-blur-sm rounded-xl p-6 border border-border-primary">
              <h3 className="text-xl font-bold text-brand-primary mb-3">30-Second Results</h3>
              <p className="text-text-secondary">Get your tailored resume in under 30 seconds. Upload, paste job description, and download.</p>
            </article>
          </div>
        </section>
